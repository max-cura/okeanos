...
use crate::stub::{_relocation_stub, _relocation_stub_end, Integrity, Relocation};
use crate::timing;
...
impl V1 {
    pub fn send_request_program_info(
        &self,
        _rz: &Reactor,
        fs: &mut FrameSink,
    ) -> Result<SendResult, ()> {
    ...
    pub fn recv_chunk(
        ...
        if msg.chunk_no == load.chunk_no as u32 {
            let State::RequestChunk { load: LoadState { info, chunk_no, num_chunks, mut hasher, relocation }}
