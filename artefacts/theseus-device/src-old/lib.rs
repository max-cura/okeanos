...
pub extern "C" fn __theseus_init() {
    ...
    loop {
        boot_umsg!(ser, "[theseus-device]: THESEUS (device firmware) v{} ({}) built {}",
            env!("CARGO_PKG_VERSION"),
            option_env!("THESEUS_DEVICE_GIT_DESC")
                .unwrap_or("<revision not specified>"),
            option_env!("THESEUS_DEVICE_BUILD_DATE")
                .unwrap_or("<data not specified>"),
        );
        ...
        boot_umsg!(ser, "[theseus-device]: fell out of download::download.");
