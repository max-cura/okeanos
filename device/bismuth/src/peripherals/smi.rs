...
use crate::arch::arm1176::timing::delay_micros;
...
proc_bitfield::bitfield! {
    ...
    pub struct CM_CTL(pub u32): Debug, IntoRaw, FromRaw, DerefRaw {
        // 5a
        pub passwd : u8 @ 24..32,
        pub mash : u8 @ 9..11,
        pub flip : bool @ 8,
...
proc_bitfield::bitfield! {
    #[repr(transparent)]
    #[derive(Eq, PartialEq, Copy, Clone)]
    pub struct CM_DIV(pub u32): Debug, IntoRaw, FromRaw, DerefRaw {
        // 5a
        pub passwd : u8 @ 24..32,
        pub divi : u16 @ 12..24,
        pub divf : u16 @ 0..12,
...
proc_bitfield::bitfield! {
    #[repr(transparent)]
    #[derive(Eq, PartialEq, Copy, Clone)]
    pub struct SMI_CS(pub u32): Debug, IntoRaw, FromRaw, DerefRaw {
        /// RX fifo full
        pub rxf: bool @ 31,
        /// TX fifo empty
        pub txe: bool @ 30,
...
proc_bitfield::bitfield! {
    #[repr(transparent)]
    #[derive(Eq, PartialEq, Copy, Clone)]
    pub struct SMI_A(pub u32): Debug, IntoRaw, FromRaw, DerefRaw {
        pub device: u8 @ 8..10,
        pub address: u8 @ 0..6,
    }
}
...
proc_bitfield::bitfield! {
    #[repr(transparent)]
    #[derive(Eq, PartialEq, Copy, Clone)]
    pub struct SMI_DC(pub u32): Debug, IntoRaw, FromRaw, DerefRaw {
...
proc_bitfield::bitfield! {
    #[repr(transparent)]
    #[derive(Eq, PartialEq, Copy, Clone)]
    pub struct SMI_DSR(pub u32): Debug, IntoRaw, FromRaw, DerefRaw {
...
proc_bitfield::bitfield! {
    #[repr(transparent)]
    #[derive(Eq, PartialEq, Copy, Clone)]
    pub struct SMI_DSW(pub u32): Debug, IntoRaw, FromRaw, DerefRaw {
...
proc_bitfield::bitfield! {
    #[repr(transparent)]
    #[derive(Eq, PartialEq, Copy, Clone)]
    pub struct SMI_DCS(pub u32): Debug, IntoRaw, FromRaw, DerefRaw {
...
proc_bitfield::bitfield! {
    #[repr(transparent)]
    #[derive(Eq, PartialEq, Copy, Clone)]
    pub struct SMI_DA(pub u32): Debug, IntoRaw, FromRaw, DerefRaw {
...
proc_bitfield::bitfield! {
    #[repr(transparent)]
    #[derive(Eq, PartialEq, Copy, Clone)]
    pub struct SMI_FD(pub u32): Debug, IntoRaw, FromRaw, DerefRaw {
...
pub fn smi_init(st: &SYSTMR, cm_smi: &CM_SMI, smi: &SMI, config: SMIConfig) {
    ...
    uart1_sendln_bl!("config is correct");
    ...
    uart1_sendln_bl!("wrote zero values");
